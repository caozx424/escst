...
<div class="cont_txt">
    ...
    <form class="form-horizontal" id="add_form" action="${ctx}/role/dosave"  method="post">
        ...
        <div class="form-group">
            <label   class="col-sm-2 control-label"><span class="red">* </span>角色编码:</label>
            <div class="col-sm-5">
        ...
        <div class="form-group">
            <label   class="col-sm-2 control-label"><span class="red">* </span>权限id:</label>
            <div class="col-sm-5">
                <input type="text" name="authority_ids" id="authority_ids" class="form-control"/>
            </div>
        </div>
