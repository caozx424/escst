...
<body>
    <div class="cont_txt">
        <p class="MUsers">区域管理->区域信息修改</p>
        <div class="tab_head">
            <ul>
            </ul>
        </div>
        <div class="container col-sm-8" style="margin-top:20px;">
            <form id="addAreaForm" class="form-horizontal" role="form"  method="post"  action="${ctx}/area/save">
                <input type="hidden" id="areaLevel" name="areaLevel" value="${areaCode.areaLevel}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="areaName" id="areaName" value="${areaCode.areaName}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="areaCode" name="areaCode" value="${areaCode.areaCode}">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input class="form-control" id="parentName"  onclick="areaTree()" value="${areaCode.parentName}">
                        <input id="parentId" name="parentId" style="display: none;" value="${areaCode.parentId}">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="areaSort" name="areaSort" value="${areaCode.areaSort}">
                        <span class="help-inline"></span>
                    </div>
                </div>
