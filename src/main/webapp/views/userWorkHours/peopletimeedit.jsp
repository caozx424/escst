...
<div class="cont_txt">
    ...
    <div class="container col-sm-8" style="margin-top:20px;">
        <form class="form-horizontal" id="add_form" action="${ctx}/peopletime/doEidt"  method="post">
             <input type="hidden" name="id" value="${peopleTimeEntity.id}"/>
            <div class="form-group">
                <label  class="col-sm-2 control-label"><span class="red">* </span>上午上班时间:</label>
                <div class="col-sm-5">
                    <input type="text" name="amup" id="amup" class="form-control" onClick="WdatePicker({dateFmt:'HH:mm:ss',maxDate:$('#amdown').val()})" value="${peopleTimeEntity.amup}"/>
                </div>
            </div>
            <div class="form-group">
                <label  class="col-sm-2 control-label"><span class="red">* </span>上午下班时间:</label>
                <div class="col-sm-5">
                    <input type="text" name="amdown" id="amdown" class="form-control" onClick="WdatePicker({dateFmt:'HH:mm:ss',minDate:$('#amup').val()})" value="${peopleTimeEntity.amdown}"/>
                </div>
            </div>
            <div class="form-group">
                <label  class="col-sm-2 control-label"><span class="red">* </span>下午上班时间:</label>
                <div class="col-sm-5">
                    <input type="text" name="pmup" id="pmup" class="form-control" onClick="WdatePicker({dateFmt:'HH:mm:ss',maxDate:$('#pmdown').val()})" value="${peopleTimeEntity.pmup}"/>
                </div>
            </div>
            <div class="form-group">
                <label  class="col-sm-2 control-label"><span class="red">* </span>下午下班时间:</label>
                <div class="col-sm-5">
                    <input type="text" name="pmdown" id="pmdown" class="form-control" onClick="WdatePicker({dateFmt:'HH:mm:ss',minDate:$('#pmup').val()})" value="${peopleTimeEntity.pmdown}"/>
                </div>
            </div>
            <div class="form-group">
                <label  class="col-sm-2 control-label"><span class="red">* </span>加班开始时间:</label>
                <div class="col-sm-5">
                    <input type="text" name="overStartTime" id="overStartTime" class="form-control" onClick="WdatePicker({dateFmt:'HH:mm:ss'})" value="${peopleTimeEntity.overStartTime}"/>
                </div>
            </div>
            <div class="form-group">
                <label  class="col-sm-2 control-label"><span class="red">* </span>到场提醒(小时):</label>
                <div class="col-sm-5">
                    <input type="text" name="warnTime" id="warnTime" class="form-control" value="${peopleTimeEntity.warnTime}"/><span class="form-group">例如：到场时间为0.5，迟到半个小时就给该人员提醒到场</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" name="noontimeRest" id="noontimeRest" class="form-control" value="${peopleTimeEntity.noontimeRest}"/><span class="form-group">例如：午休时间为1.5</span>
                </div>
            </div>
            <div class="form-group">
